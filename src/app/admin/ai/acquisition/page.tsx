...
export default async function AdminAcquisitionPage() {
  ...
  const agents: AgentInfo[] = [
    ...
    { id: "5", name: "Manon Verhoeven", role: "Rédaction", persona: "Creative Copywriter", description: "Transforme l'audit technique en accroche asymétrique ultra-personnalisée (Liquid Glass).", value: proof.drafted, valueLabel: "Brouillons rédigés", status: statusOf(["Outreach Copywriter AI", "Creative Copywriter"]), lastLog: logOf(["Outreach Copywriter AI", "Creative Copywriter"]) },
